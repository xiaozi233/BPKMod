...
public abstract class MixinBlockTrapDoor extends Block {
    ...
    @Shadow @Final @Mutable protected static AxisAlignedBB BOTTOM_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.1825D, 1.0D);
    @Shadow @Final @Mutable protected static AxisAlignedBB TOP_AABB = new AxisAlignedBB(0.0D, 0.8175D, 0.0D, 1.0D, 1.0D, 1.0D);
